...
const ReviewsSection = ({ reviews, doctorID, setReviews }) => {
    ...
    const handleSubmitReview = async () => {
        ...
        if (selectedReview) {
            ...
            try {
                ...
                const response = await updateReview(updatedReview.ReviewID, userID, updatedReview);
                if (response.success) {
    ...
    return (
        <View style={{ flex: 1, height: 120, backgroundColor: colors.blue_light }}>
